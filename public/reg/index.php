                ...
                <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">
                    <form class="mdl-card mdl-cell mdl-cell--12-col" action="verify.php" method="POST">
                        <div class="mdl-card__supporting-text mdl-grid mdl-grid--no-spacing">
                            ...
                            <p>答题内容皆为组规相关，请先阅读组规再行答题：<a href="https://xn--ltwa.xn--fmrv2rkpbv8uymm.com/%E2%98%94%E6%80%BB%E7%89%88%E8%A7%84" target="_blank">小狗梦工厂组规2.2</a></p>
                            <p>答题完成即默认你已同意社区的行为规范准则，请不要反复注册小号，一经系统检测为恶意注册ip，即自动封禁ip</p>
                            <div class="mdl-grid">
                                <?php
                                // 遍历获取到的题目列表生成前端组件
            ...
            <footer class="mdl-mega-footer">
                <div class="mdl-mega-footer--bottom-section">
                    ...
                    <ul class="mdl-mega-footer--link-list">
                        <li><a href="/">主页</a></li>
                        <li><a href="https://weibo.com/u/7643769852" target="blank">站外公告栏</a></li>
                    </ul>
                </div>
            </footer>
        </main>
