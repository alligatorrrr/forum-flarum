 ...
 */
type feApp = (provider: string, name: string, getProviderData?: (providerDatas: {
    [key: string]: string;
}, specialProviderKeyCallback: Record<string, () => Promise<string>>) => Promise<void>, getShowCase?: (item: any, purchase_history?: any) => any, getUseData?: (item: any) => Promise<string>) => void;
